                ...
                <div className="navbar-heading mt-2">
                    <h3 style={{ marginLeft: '30px' }}>
                        <a className="navbar-h ms-5" to="/">
                            <img src="https://static.vecteezy.com/system/resources/previews/024/521/349/original/train-transparent-background-png.png" style={{ height: '50px' }} alt="Logo" className="logo-image me-3" />
                            Rail Rover
                        </a>
                    </h3>
                </div>
